...
class QuickApi:
    ...
    def add_action(
        ...
        :type text: str
elf.dlg.map_button.clicked.connect(self._on_map_click)  # added line
    ...
    def _on_map_click(self):
        """runs when map button is clicked"""
        self.dlg.hide()
    ...
    def run(self):
        ...
        # save referenc to current project
    ...
    def result(self, result):
        ...
        if result:
            ...
            # Note, QgsPointXY is not a geometry yet??? this note isnt explained further not sure what its getting at
            ...
            layer_out = QgsVectorLayer("Point?crs=EPSG:4326&field=address:string&field=license:string",
                           ...
                           "memory")
            # Remember, QgsPointXY is not a geometry, only a Point object (confusing, really, since QgsPoint is a geometry)
            ...
            if project.crs().authid() != 'EPSG:4326':
                xform = QgsCoordinateTransform(crs_out,project.crs(),project)
